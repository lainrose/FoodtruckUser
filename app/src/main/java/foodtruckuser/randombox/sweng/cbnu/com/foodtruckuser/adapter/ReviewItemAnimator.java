 ...
 */
public class ReviewItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
            lastAddAnimatedItem++;
            runEnterAnimation((ReviewItemAdapter.ReviewViewHolder) viewHolder);
            return false;
        }
    ...
    private void runEnterAnimation(final ReviewItemAdapter.ReviewViewHolder holder) {
        final int screenHeight = Utill.getScreenHeight(holder.itemView.getContext());
    ...
    private void animatePhotoLike(final ReviewItemAdapter.ReviewViewHolder holder) {
    ...
    private void dispatchChangeFinishedIfAllAnimationsEnded(ReviewItemAdapter.ReviewViewHolder holder) {
    ...
    private void resetLikeAnimationState(ReviewItemAdapter.ReviewViewHolder holder) {
